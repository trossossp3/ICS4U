...
function displayScore(id) {
  ...
  switch (id) {
    case 0:
      ...
      ctx.textAlign = "center";
      ctx.fillText(
        "Player " + id + " score: " + players[id].score,
        canvas.width / 2,
        540
      );
      break;
...
function displayComputer(id) {
  ...
  for (var i = 0; i < numCards; i++) {
    ...
    function goFish(playerID) {
      ...
      else if (temp == 11) temp = "J";
      else if (temp == 12) temp = "Q";
      else if (temp == 13) temp = "K";
      else temp = "A";
    ...
    function transact(cur, guess, person) {
      ...
      if (guess <= 10) guess = guess;
      else if (guess == 11) guess = "J";
      else if (guess == 12) guess = "Q";
      else if (guess == 13) guess = "K";
      else guess = "A";
      message +=
        "Player: " + cur + " got a " + guess + " from Player " + person + "*";
    }
